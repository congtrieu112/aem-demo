 ...
 */
package com.devblockhomepagesample.core.models;
...
import com.devblockhomepagesample.core.testcontext.AppAemContext;
...
class HelloWorldModelTest {
    ...
    public void setup() throws Exception {
        ...
        resource = context.create().resource(page, "hello",
            "sling:resourceType", "devblockhomepagesample/components/helloworld");
